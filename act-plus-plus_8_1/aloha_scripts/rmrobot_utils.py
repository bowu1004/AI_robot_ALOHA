...
class ImageRecorder:
    def __init__(self, init_node=True, is_debug=False):
        ...
        for cam_name in self.camera_names:
            ...
            if cam_name == 'cam_high':
                ...
                rospy.Subscriber("/camera_left/color/image_raw", Image, callback_func)
                ...
                rospy.Subscriber("/camera_right/color/image_raw", Image, callback_func)
            else:
                print(cam_name)
    ...
    def get_images(self):
        ...
        image_dict['cam_high'] = image_dict['cam_left_wrist']
        # print(image_dict)
        return image_dict
